...
<html>
<head>
<title>You're almost there: just one more step!</title>
...
<ul>
<li><b>You must confirm your subscription if you want to receive e-mails from The Tyee (thetyee@response.thetyee.ca).</li>
<br />
<li>Please take a moment to do that now. You may want to look in your junk folder if you can't find the message at first.</b></li>
</ul>
