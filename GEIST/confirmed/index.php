...
<head>
	<title>You have successfully subscribed to this list</title> <style>
...
<img src="http://thetyee.ca/ui/img/logo.png" alt="News and Views for British Columbia" width="263" height="89" border="0" />
		...
		<tr>
			<td class="loginHeader">
				&nbsp;<strong>Your e-mail has been confirmed</strong> 
			</td>
		</tr>
	</table>
	<table width="500" / cellspacing="0" cellpadding="15" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td>
				...
				<p style="background:#FFFFCC;padding:8px;border:2px solid #FFCC00;"><b>If you are one of the first 200 people to subscribe to this special offer, you will receive your free subscription from Geist in the coming months.</b></p>
				<p>
				...
				<ul>
					...
					<li>
					<a href="http://thetyee.ca/About/SpreadTheWord/">Tell your friends about the Tyee</a>
					</li>
					<li>
