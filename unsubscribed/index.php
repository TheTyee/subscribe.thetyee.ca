...
<head>
	<title>You have successfully unsubscribed.</title> <style>
...
<img src="http://thetyee.ca/ui/img/logo.png" alt="News and Views for British Columbia" width="263" height="89" border="0" />
	...
	<table width="500" / cellspacing="0" cellpadding="15" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td>
				<p>
					We have added you to our "Global Opt-out" list, which means that our newsletter system will refuse to send you any further email without manual intervention by our administrator. 
				</p>
				<p>
					If there is an error in this information, you can re-subscribe: by <a href="http://subscribe.thetyee.ca">visiting this page and filling in the form to re-subscribe</a>. 
				</p>
					<br />
						<br />
				<p>
