...
<img src="http://thetyee.ca/ui/img/logo.png" alt="News and Views for British Columbia" width="263" height="89" border="0" />
	...
	<table width="500" / cellspacing="0" cellpadding="15" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td>
				<p>
					<b>Just One More Step!</b>
				</p>
				<p>

    <b>Step 3</b>: Go back to your email to find another email from us. It might take a moment to come through. In it, you'll find a link to the voting form for The REEL BC Video Contest. 
</p><p>
